...
Clean and prepare hospital patient data for analysis.
Perform exploratory data analysis (EDA) using Microsoft Excel.
Store and query the data using Microsoft SQL Server.
...
Total treatment costs exceeded R8.2 million.
